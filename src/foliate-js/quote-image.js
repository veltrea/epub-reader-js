...
// 影の DOM 用の CSS。<style> 要素にすると Tauri が入れる CSP の nonce に弾かれるので
// 構築済みスタイルシートで入れる(理由は paginator.js の同じ改変の注釈を参照)。
...
const html = `<main style="width: ${width}px; height: ${height}px; overflow: hidden; display: flex; flex-direction: column; justify-content: center; text-align: center; background: #fff; color: #000; font: 16pt serif">
    <style>
    .ellipsis {
        overflow: hidden;
        display: -webkit-box;
